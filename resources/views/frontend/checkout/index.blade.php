                        ...
                        <div class="wrap-address-billing">
                                ...
                                <h3 class="box-title">Billing Address</h3>
                                    ...
                                    <p class="row-in-form">
                                        ...
                                        <input id="province" type="text" name="province" value="{{ Auth::user()->province }}"
                                    ...
                                    <p class="row-in-form">
                                        ...
                                        <input id="district" type="text" name="district" value="{{ Auth::user()->district }}"
                                            placeholder="District name">
                                    </p>
                                    <p class="row-in-form">
                                        <label for="message">Note</label>
                                        <input id="message" type="text" name="message" value="{{ old('message') }}" placeholder="Your notes">
                                    </p>
