                                ...
                                <div class="tab-content-item active" id="digital_1a">
                                    <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container"
                                        ...
                                        @foreach ($latest_products as $latest)
                                            <div class="product product-style-2 equal-elem ">
                                                <div class="product-thumnail">
                                                    <a href="{{ url('/collections') . '/' . $category->slug . '/' . $latest->slug }}"
                                                        title="{{ $latest->name }}">
                                                        <figure><img
                    ...
                    <div class="wrap-product-tab tab-style-1">
                        <div class="tab-control">
                            @foreach ($categories as $index => $cate)
                                <a href="#{{ $cate->name }}" class="tab-control-item {{ $index == 0 ? 'active' : '' }}">{{ $cate->name }}</a>
                            @endforeach

                        </div>
                        <div class="tab-contents">
                            @foreach ($categories as $index => $cate)
                                <div class="tab-content-item {{ $index == 0 ? 'active' : '' }}" id="{{ $cate->name }}">
                                    <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container"
                                        data-items="5" data-loop="false" data-nav="true" data-dots="false"
                                        data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
                                        ...
                                        <div class="product product-style-2 equal-elem ">
                                            <div class="product-thumnail">
                                                <a href="detail.html"
                                                    ...
                                                    <figure><img src="assets/images/products/fashion_01.jpg"
